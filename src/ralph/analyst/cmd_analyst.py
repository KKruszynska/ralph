...
class CmdAnalyst(Analyst):
    """
    This is a class that creates a colour-magnitude diagram for one event, one catalogue
    and one solution.
    ...
    * `separator` str, separator used in the file with the catalogue
    ...
    def add_cmd_config(self, catalogue, config_dict):
        ...
        cmd_config = \
            [cat_dict for cat_dict in config_dict['cmd_analyst']['catalogues']
             if cat_dict['name'] == catalogue][0]
    ...
    def transform_source_data(self):
        ...
        assigned in different filter to source, blend and baseline, and a list with band labels.
    ...
    def plot_cmd(self, source_data, source_labels, cmd_data, cmd_labels):
        ...
        for i in range(len(cmd_labels)):
            ...
            colours = {'baseline': '#000000',  # black
                       ...
                       'reddish_purple': '#CC79A7'}  # reddish_purple
            try:
                fig = go.Figure()
                    ...
                    fig.add_trace(
                        go.Scatter(
                            ...
                            error_x=dict(
                                ...
                                array=[np.sqrt(source_data[cmd_labels[1]].iloc[j][1] ** 2
